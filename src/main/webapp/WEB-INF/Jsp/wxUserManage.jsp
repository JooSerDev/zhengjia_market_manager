			...
			<div class="panel-body">
				<form id="formSearch" class="form-horizontal">
					<div class="form-group" style="margin-top: 15px">
						<label class="control-label col-sm-1" for="state">筛选项</label>
						<div class="col-sm-2">
	...
	var ButtonInit = function() {
		...
		oButtonInit.Init = function() {
			$("#btn_query").bind("click", function() {
				$('#wxUserInfo').bootstrapTable('refresh',{url:'${pageContext.request.contextPath}/wx/userList'});
			});
		};
		return oButtonInit;
	};
...
// 					checkbox : true
				...
				onClickRow : function(row) {
					window.location.href="${pageContext.request.contextPath}/wx/userDetail?userId="+row.userId;
				}
			});
		};
